...
class MainWindow:
    ...
    def __init__(self, root):
        ...
        self.label_text = Label(
            root, text="Welcome to the typing speed test application!", wraplength=500)
        ...
        self.btn_newtext = Button(root, text="Get new sentence", command=self.new_text)
...
def main():
    ...
    window.bind('<Control-Key-s>', lambda event: myapp.start())
    window.bind('<Return>', lambda event: myapp.stop())
    window.mainloop()
